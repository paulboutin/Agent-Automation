...
prompt_dir="${worktree}/{{AUTOMATION_ROOT}}/prompts"
mkdir -p "${prompt_dir}"
...
5. If the review pack exists, self-check against ./${{AUTOMATION_ROOT}}/packs/review/checklist.md before finishing.
6. If the QA pack exists, include the validation evidence requested by ./${{AUTOMATION_ROOT}}/packs/qa/checklist.md when relevant.
